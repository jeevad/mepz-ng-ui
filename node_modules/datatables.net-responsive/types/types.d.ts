...
declare module 'datatables.net' {
	...
	interface ApiStatic {
		...
		Response: {
			 ...
			 */
			new (dt: Api<any>, settings: boolean | ConfigResponsive) : Response;
...
interface ConfigResponsiveDetails {
	 ...
	 */
	display?(row : any, update : any, render : any): boolean;
	 ...
	 */
	renderer?(api : any, rowIdx : any, columns : any): Node | false;
