...
// chart 5
 var ctx = document.getElementById('chart5').getContext('2d');
      ...
      var gradientStroke1 = ctx.createLinearGradient(0, 0, 0, 500);
      gradientStroke1.addColorStop(0, '#84D2C5');
      gradientStroke1.addColorStop(1, '#9DF1DF');
      
      var gradientStroke2 = ctx.createLinearGradient(0, 0, 0, 200);
      gradientStroke2.addColorStop(0, '#BA94D1');
      gradientStroke2.addColorStop(1, '#7F669D');
