...
export class AccountService {
  ...
  accountsKey: string = 'hanimedAccountsKey';
  ...
  login(userName: string, password: string) {
    // this.http.post(environment.apiUrl + '/project');
    return this.http
      .post<any>(
        `${baseUrl}auth/login`,
        { userName, password }
      ...
      .pipe(
        ...
        user.jwtToken = account.jwtToken;
  ...
  setAccount(account: any) {
    localStorage.setItem(this.accountsKey, JSON.stringify(account));
  }
  getAccount(): any {
    return JSON.parse(localStorage.getItem(this.accountsKey)!) || null;
  }
  logout() {
    // this.http
